...
class TarifaCuetoSolaController extends Controller
{
    /**
    ...
    {
        return \App\TarifaCuetoSola::All();
    }
    ...
    public function store(Request $request)
    {
        ...
        if($nuevoConvenio=\App\TarifaCuetoSola::create($request->all())){
           return response()->json(['status'=>'ok', 'TarifaCuetoSola'=>$nuevoConvenio], 200);
        }else{
    ...
    public function update(Request $request, $id)
    {
        ...
        $convenio=\App\TarifaCuetoSola::find($id);
