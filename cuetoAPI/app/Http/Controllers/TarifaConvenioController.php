...
class TarifaConvenioController extends Controller
{
    /**
    ...
    public function store(Request $request)
    {
        ...
        if($nuevoConvenio=\App\TarifaConvenio::create($request->all())){
           return response()->json(['status'=>'ok', 'TarifaConvenio'=>$nuevoConvenio], 200);
        }else{
    ...
    public function update(Request $request, $id)
    {
        ...
        $convenio=\App\TarifaConvenio::find($id);
